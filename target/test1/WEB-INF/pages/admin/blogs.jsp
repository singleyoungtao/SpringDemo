        ...
        <div class="container">
            ...
            <c:if test="${empty blogList}">
                <div class="alert alert-warning" role="alert">
                    <span class="glyphicon glyphicon-info-sign" are-hidden="ture"></span>Blog表为空，请<a href="/admin/blogs/add" type="button" class="btn btn-primary btn-sm">添加</a>
                </div>
            </c:if>
                    ...
                    <c:forEach items="${blogList}" var="blog">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/blogs/delete/${blog.id}" type="button" class="btn btn-sn btn-danger">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
